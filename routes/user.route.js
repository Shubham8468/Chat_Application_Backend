...
import { signin,signup,signout,getUser,updateProfile, updatePresence } from '../controllers/user.controller.js';
...
router.put('/presence',isAuthenticated,updatePresence)
